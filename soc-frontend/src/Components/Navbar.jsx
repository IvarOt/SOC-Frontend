                ...
                <div className="d-flex flex-row align-items-center mx-4">
                    ...
                    <ul className="navbar-nav d-flex flex-row align-items-center">
                        ...
                        {!user ? (
                            ...
                            <>
                                <li className="nav-item me-4">
                                    <Link to="/Profile" className="nav-link active"> <img width="24" height="24" src="https://img.icons8.com/material-outlined/24/FFFFFF/gallery.png" alt="gallery" />Profile</Link>
                                </li>
                                <li className="nav-item me-4">
